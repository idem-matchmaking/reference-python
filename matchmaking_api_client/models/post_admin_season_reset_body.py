...
if TYPE_CHECKING:
    from ..models.post_admin_season_reset_body_percentages_item import (
        PostAdminSeasonResetBodyPercentagesItem,
    )


T = TypeVar("T", bound="PostAdminSeasonResetBody")


@_attrs_define
class PostAdminSeasonResetBody:
    """
    Attributes:
        season_name (Union[Unset, str]):
        season_start (Union[Unset, str]): datetime for the start of the season in isoformat
        percentages (Union[Unset, List['PostAdminSeasonResetBodyPercentagesItem']]):
    """

    season_name: Union[Unset, str] = UNSET
    season_start: Union[Unset, str] = UNSET
    percentages: Union[Unset, List["PostAdminSeasonResetBodyPercentagesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for percentages_item_data in _percentages or []:
            percentages_item = PostAdminSeasonResetBodyPercentagesItem.from_dict(
                percentages_item_data
            )

            percentages.append(percentages_item)

        post_admin_season_reset_body = cls(
            season_name=season_name,
            season_start=season_start,
            percentages=percentages,
        )

        post_admin_season_reset_body.additional_properties = d
        return post_admin_season_reset_body
